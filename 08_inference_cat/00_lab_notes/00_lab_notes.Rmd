...
Lab 2 generalizes inference for binomial proportions to the setting of two-way contingency tables and also discusses measures of association in two-by-two tables.
...
The following example shows the HIV data re-entered to be in the preferred format, where the rows of the table specify the type of drug treament and the columns specify the outcome. Note that the second column specifies virologic failure.
