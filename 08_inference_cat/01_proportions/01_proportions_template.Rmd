...
author: "Chapter 8, Lab 1: Template"
...
By default, R applies a 'continuity correction' that results in the calculated confidence interval being slightly different from one from the hand calculation. 
...
In prop.test( ), the argument p refers to p_0. 
...
In binom.test( ), the argument p refers to p_0. 
