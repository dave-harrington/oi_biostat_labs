...
author: "Chapter 2, Lab 2: Template"
...
<!---
Change eval = FALSE to TRUE for the output to display in the knitted PDF.
--->
...
<!---
Once the code is complete, change eval = FALSE to TRUE for the output to display in the knitted PDF.
--->
