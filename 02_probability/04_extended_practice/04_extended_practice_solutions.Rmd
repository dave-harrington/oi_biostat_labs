...
a) Suppose that two parents have brown eyes. What is the probability that their first child has blue eyes?
    ...
    Note that the $\times$ represents a mating between two genotypes; e.g. $BB \times BB$ represents a mating between two $BB$ individuals.
	
    \textit{\Tree [.X [.BB$\times$BB [ Y $Y^C$ ] ] [.Bb$\times$Bb [ Y $Y^C$ ] ] [.BB$\times$Bb [ Y $Y^C$ ] ] ]} 
	
    Solve for $P(Y|X)$, which is given by adding together the probabilities of the three branches ending in $Y$.\footnote{The total probability equation : $P(Y|X) = [P(BB \times BB | X) \times P(Y| BB \times BB)] + [P(Bb \times Bb | X) \times P(Y| Bb \times Bb)] + [P(BB \times Bb | X) \times P(Y| BB \times Bb)]$}
    ...
    \begin{align*}
		...
		=& \left[\dfrac{P(X|BB) \times P(BB)}{[P(X|BB) \times P(BB)] + [P(X|Bb) \times P(Bb)]} \right]^2 \\
    ...
    \begin{align*}
		P(BB \times Bb | X) =& 2 \times P(BB|X) \times P(Bb|X) \\
		=& 2 \times (1/3) \times (2/3) \\
		=& \dfrac{4}{9}
    \end{align*}
...
b) Does the probability in part a) change if it is now known that the paternal grandfather had blue eyes? Justify your answer.
    ...
    \begin{align*}
	P(Y|X) =& 0 + [P(Bb \times Bb | X) \times P(Y| Bb \times Bb)] + 0 \\
	=& (2/3)(1/4) \\
	=& \dfrac{1}{6}
    \end{align*}	
...
c) Given that their first child has brown eyes, what is the probability that their second child has blue eyes? Ignore the condition given in part b).
    ...
    \begin{align*}
	P(Z|X, Y^C) &= [P(BB \times BB | X, Y^C)(P(Z|BB \times BB, X, Y^C)] \\
	& \qquad + [P(Bb \times Bb | X, Y^C)(P(Z|Bb \times Bb, X, Y^C)] \\
	& \qquad + [P(BB \times Bb | X, Y^C)(P(Z|BB \times Bb, X, Y^C)]
    \end{align*}
    ...
    \begin{align*}
	P(Bb \times Bb | X, Y^C) &= \dfrac{P(Bb \times Bb | X) \times P(Y^C | Bb \times Bb, X)}{P(Y^C | X)}
    \end{align*}
    ...
    \begin{align*}
	P(Y^C|X) &= [(P(BB \times BB | X)) (P(Y^C | BB \times BB, X))] + [(P(BB \times Bb | X)) (P(Y^C | BB \times Bb, X))] \\
	& \qquad + [(P(Bb \times Bb | X))(P(Y^C | Bb \times Bb, X))] \\
	&= \left[ \left(\dfrac{1}{3} \right)^{2} \times 1 \right] + \left[ 2 \times \left( \dfrac{1}{3}\right) \left(\dfrac{2}{3} \right) \times 1 \right] + \left[ \left(\dfrac{2}{3} \right)^{2} \times \dfrac{3}{4} \right] \\
    ...
    \begin{align*}
	P(Bb \times Bb | X, Y^C) &= \dfrac{P(Bb \times Bb | X) \times P(Y^C | Bb \times Bb, X)}{P(Y^C | X)} \\
	&= \dfrac{\left[ \left(\dfrac{2}{3} \right)^{2} \times \dfrac{3}{4} \right]}{\dfrac{8}{9}} = \dfrac{3}{8}
    \end{align*}
