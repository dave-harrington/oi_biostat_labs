...
The following code shows how to calculate the value of the observation where there is 0.841 area to the left (and 0.159 area to the right) on a $t$-distribution with 20 degrees of freedom.
...
#conduct test
t.test(nhanes.samp.adult$Height, mu = 168, alternative = "less", conf.level = 0.90)
```
