...
author: "Chapter 1, Lab 1: Solution"
...
Before genes can be translated into proteins, DNA must first be transcribed into RNA. The dataset \texttt{coding.mrna} contains the length of known protein-coding transcripts (measured in base pairs). Load the dataset from the \texttt{oibiostat} package using the \texttt{load()} command.
