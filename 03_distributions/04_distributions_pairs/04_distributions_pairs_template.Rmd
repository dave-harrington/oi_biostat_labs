...
author: "Chapter 3, Lab 4: Template"
...
<!---
If you get an error message when loading the reshape package, you will need to install it first.

Run install.packages("reshape") to install the package; you will then be able to load it.
--->
