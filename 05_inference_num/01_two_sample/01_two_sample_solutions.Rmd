...
```
    ...
    \textcolor{NavyBlue}{Consider an independent group design for the swim study: 24 swimmers could be selected, in which one half of the swimmers complete a 1500m swim wearing a wetsuit and the other half swim wearing a swimsuit. In order for there to be sufficient evidence of a difference, the difference in means must be large relative to the standard error, which accounts for the variation in swim velocities within groups.} 
    
    \textcolor{NavyBlue}{A paired study design takes advantage of the correlation between two observations in a pair; in the context of the swim study, each swimmer acts as their own control.} 
