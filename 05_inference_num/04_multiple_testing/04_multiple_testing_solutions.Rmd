...
```
    ...
    \textcolor{NavyBlue}{The value \texttt{TRUE} correspondes to AML patients, while \texttt{FALSE} corresponds to ALL patients. The boxplot shows that the gene in the first column has lower median expression in AML patients relative to ALL patients.}
