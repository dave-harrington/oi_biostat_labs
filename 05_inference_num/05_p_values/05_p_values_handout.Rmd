...
author: "Chapter 5, Lab 5: Handout"
...
```
    ...
    d) Estimate the probability that the alternative hypothesis is true, given that we reject $H_0$. This is analogous to estimating the probability of a "true positive" result, in the language 
